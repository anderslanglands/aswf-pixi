...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon` version `26.05.4.6d9726091`, with the recipe source pinned to full commit `6d9726091cee813c075f70f14519b7dad278c6f9`.
