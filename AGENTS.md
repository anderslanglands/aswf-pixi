...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon` version `26.05.2.05126acbb`, with the recipe source pinned to full commit `05126acbb70fda815c1071c42641c2e056f61dc8`.
