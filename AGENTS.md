...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon` version `26.05.3be04db`, with the recipe source pinned to full commit `3be04db599558b57b36071281aecded9b81d653b`.
