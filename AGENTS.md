...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon` version `26.05.3.2aa94b0ab`, with the recipe source pinned to full commit `2aa94b0ab1f19760c2f5b5c7bc6505cd5e2a75bc`.
