...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon` version `26.05.0beaac8`, with the recipe source pinned to full commit `0beaac8deef31ed959c340f03e0a879cf81ecdc1`.
