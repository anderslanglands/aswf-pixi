...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon` version `26.05.6.72fa115c7`, with the recipe source pinned to full commit `72fa115c7a1ddba6f3cf48a1450d5ff138d30441`.
