...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon` version `26.05.9.ea5b6f695`, with the recipe source pinned to full commit `ea5b6f695d983f0837584b419aa8053f8e0a4260`.
