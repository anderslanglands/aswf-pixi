...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon`; the current recipe is version `26.08.10.121e74ef7`, pinned to full commit `121e74ef79f11d38effb31c0d8a1c4ac2658b4fe`.
