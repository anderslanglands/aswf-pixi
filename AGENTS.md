...
- Package the NVIDIA Omniverse `OpenUSD` `typhoon-anders` branch as `openusd-typhoon` version `26.05.1.a99d9b6`, with the recipe source pinned to full commit `a99d9b68b5c9c6452a5ef3e237e16f00c3940fea`.
